...
label{
	...
	<a href="#" class="Logo" style = "margin-right: 473px ">FENIX<!--<img src="logo.png" alt="" style="width:45%; height:45%;">--></a>
	<ul>
	<li><a style="color:black; margin-right:500px;font-size:18px" >CONTRATACIÓN</a></li>
	</ul>
  ...
  <input type='submit' name='Cerrar' class='btn btn-primary' onclick="window.location.href = 'PaginaBienvenida.php'" value="CERRAR SESIÓN" style="background-color:white; color:black; border-radius:10px; width:130px ;font-size:15px" >	
	...
	var header = document.querySelector("header");
		...
		<br><br>
		<center> <h2 style="color:black; font-family:'Poppins', sans-serif; font-weight:bold; letter-spacing: 2px;font-size:45px">HABILIDADES</h2></center>
		<center> 
			<br><br>
			<div class="col-md-6">	
				<?php
					$Metodos->Listado_habilidad($query,"","PaginaTrabajadoresEmpresa.php","");
				?>
				<a href="PaginaTrabajadoresEmpresa.php?session=<?php echo $indice ?>">
			...
			<br>
			<center>			
			<h1 id="contacto" style="color:black; font-weight:bold; font-size:40px">CONTACTANOS</h1><br>
